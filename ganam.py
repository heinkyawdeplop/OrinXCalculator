...
# ==================== CONFIGURATION ====================
BOT_TOKEN = "8501053348:AAHpkfCxLvX_bKjhdC1ReDUDvce_AElpYtU"
OWNER_ID = 7887025848

# JSONBin.io Configuration (Environment variable သုံးမယ်)
# Terminal မှာ ဒီလိုသတ်မှတ်ပါ:
# export JSONBIN_API_KEY="$2a$10$P0Y2YbJv3tTnkseLZkEkn.Tzgt9W6lOOA6.0VZ5VXlbMBpzvX30k"
# export JSONBIN_BIN_ID="6a03dbffadc21f119a90a97d"

# ==================== JSONBin.io DATABASE ====================
class JSONBinDB:
    def __init__(self):
        # Environment variable က လာတဲ့ တန်ဖိုးများ
        self.api_key = os.environ.get("$2a$10$P0Y2YbJv3tTnkseLZkEkn.Tzgt9W6lOOA6.0VZ5VXlbMBpzvX30k")
        self.bin_id = os.environ.get("6a03dbffadc21f119a90a97d")
        self.users = {}
        self.groups = {}
        self.start_time = time.time()
        
        # Fallback values (Environment variable မရှိရင် ဒီတန်ဖိုးသုံးမယ်)
        if not self.api_key:
            self.api_key = "$2a$10$yfXmXpNq1yjY1gQ4dHt1iu9Tz76gqne9v7Bx5CnGSsRcSLdugs0ZG"
            print("⚠️ Using hardcoded API key")
        if not self.bin_id:
            self.bin_id = "6a03dbffadc21f119a90a97d"
            print("⚠️ Using hardcoded BIN ID")
